...
![Open Data Hub > Field mappings to see your account's mapped fields and their data types](./360-data-configuration-field-mappings-g0-step-1.png)
...
![Hover a field row and click the edit pencil to change its data type, then click Save](./360-data-configuration-field-mappings-g0-step-2.png)
